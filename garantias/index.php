...
<html ng-app="AppYonke">
    <head>
        <meta charset="UTF-8" />
        <title>Yonke The Car Depot | garantias</title>
 ...
 <?php include_once("../includes/menu.html"); ?>
    ...
    <body ng-controller="garantiaController">
      <div class="container">
        <div class="row">
          <div class="col l12">
            <table  class="center">
              <tr ng-repeat="garantia in garantias">
                <td width="110"><img  ng-src="../{{ garantia.foto }}"></td>
                <td width="678">{{garantia.texto}}
              </tr>
            </table>
